...
if [ $maxfreq -gt 1500000 ]; then
	echo "3) 1.9 undervolted, overclocked to 1.9Ghz"
	echo "4) 1.9X: extremely undervolted, overclocked to 1.9Ghz"
fi
...
# 1.92
	...
	echo 'echo "1222400 1150" > $sysfile' >> $ifile
	echo 'echo "1408000 1250" > $sysfile' >> $ifile
	echo 'echo "1600000 1375" > $sysfile' >> $ifile
	echo 'echo "1800000 1425" > $sysfile' >> $ifile
	echo 'echo "1900000 1450" > $sysfile' >> $ifile
	echo 'echo 245760 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq' >> $ifile
	echo 'echo 1900000 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq' >> $ifile
	sh $ifile
;;
4)
# 1.92X
	echo "#!/system/bin/sh" > $ifile
	echo "# Mode: 1.9X" >> $ifile
	echo 'sysfile="/sys/devices/system/cpu/cpu0/cpufreq/vdd_levels"' >> $ifile
	chmod 555 $ifile
	[ $minfreq -lt 200000 ] && echo 'echo "184320 750" > $sysfile' >> $ifile
	echo 'echo "245760 825" > $sysfile' >> $ifile
	...
	echo 'echo "1222400 1125" > $sysfile' >> $ifile
	echo 'echo "1408000 1175" > $sysfile' >> $ifile
	echo 'echo "1600000 1250" > $sysfile' >> $ifile
	echo 'echo "1800000 1325" > $sysfile' >> $ifile
	echo 'echo "1900000 1400" > $sysfile' >> $ifile
	echo 'echo 245760 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq' >> $ifile
	echo 'echo 1900000 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq' >> $ifile
	sh $ifile
;;
